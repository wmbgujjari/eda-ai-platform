...
async def train_demand(train_year: str,train_month: str,officeId: str,model_name: str):
    ...
    try:
        ...
        for division_id, section_id in division_section_map.items():
            ...
            signature("FG.tasks.demand_tasks.fetch_data_and_train", args=[section_id, task_id, train_year, train_month,model_name], queue="demand_queue").apply_async()
        ...
        return {"message": "Demand model training started in the background.", "task_id": task_id}
